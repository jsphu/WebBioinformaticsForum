        ...
        <div className="popup-form">
          ...
          {nodeType !== "output" && (
            <>
              ...
              >
                {[...edgeData.source, { data }].flatMap((input, index) => {
                  const entries = Object.entries(input.data?.params || {});
                ...
                input.type !== "parametersNode" ? (
                  <label key={`input-${input.id || index}`}>
                    ...
                    <input
                      ...
                      onChange={(e) => handleChange(e, index, "inputs")}
                      placeholder={`Input${index + 1}`}
                      onMouseOver={() => handleFocus(index, true)}
                ...
                return (
                  <label key={`output-${output.id || index}`}>
                    ...
                    <input
                      ...
                      onChange={(e) => handleChange(e, index, "outputs")}
                      placeholder={`Output${index + 1}`}
                      onMouseOver={() => handleFocus(index, false)}
